...
//        userList = AppPrefs.get().getUsers();
...
//        AppPrefs.get().saveUsers(userList);
    ...
    public void AppendLocalRecord(UserItem person, int type) {
        ...
        rs.id = person.id;
        rs.name = person.name;
        rs.matric_no = person.matric_no;
        rs.address = person.address;
        rs.card = person.address;
        rs.department = person.department;
        rs.dob = person.dob;
        rs.sex = person.sex;
        rs.marrital_status = person.marrital_status;
        rs.card = person.card;
        rs.card_serial = person.card_serial;
        rs.religion = person.religion;
        rs.email = person.email;
        rs.phone = person.phone;
        rs.faculty = person.faculty;
        rs.first_name = person.first_name;
        rs.last_name = person.last_name;
        rs.home_town = person.home_town;
        rs.madien_name = person.madien_name;
        rs.middle_name = person.middle_name;
        rs.level = person.level;
        rs.lga = person.lga;
        rs.state = person.state;
        rs.nationality = person.nationality;
        rs.nok_address = person.nok_address;
        rs.nok_email = person.nok_email;
        rs.nok_name = person.nok_name;
        rs.nok_phone = person.nok_phone;
        rs.session = person.session;
        rs.specialization = person.specialization;
        rs.department = person.department;
        rs.home_town = person.home_town;
