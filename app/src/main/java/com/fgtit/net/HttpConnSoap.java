...
public class HttpConnSoap {
	...
	public ArrayList<String> GetWebServer(String serverUrl, String methodName, ArrayList<String> Parameters, ArrayList<String> ParValues) {
		
		ArrayList<String> Values = new ArrayList<String>();
		String ServerUrl = serverUrl;//"http://192.168.1.124/FingermapWebApp/FingermapService.asmx";
		String soapAction = "http://www.hfteco.com/" + methodName;
		String soap = "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
					+ "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
					+ "<soap:Body>";
		String tps, vps, ts;
		String mreakString = "";
		mreakString = "<" + methodName + " xmlns=\"http://www.hfteco.com/\">";
